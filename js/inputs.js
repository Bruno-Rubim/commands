...
function inputInterpreter(inputValue) {
    ...
    console.log(JSON.parse(JSON.stringify(gameState.currentFolder.content)), "before command");
    switch (commandArguments[0]) {
        case "cd":
            changePath(commandArguments[1], gameState.currentMachine);
            console.log(JSON.parse(JSON.stringify(gameState.currentFolder.content)), "after changePath");
            break;
        case "ls":
            listFolderContent();
            break;
        case "cat":
            ...
            console.log(JSON.parse(JSON.stringify(gameState.currentFolder.content)), "after cat");
            break;
        case "help":
    ...
    console.log(JSON.parse(JSON.stringify(gameState.currentFolder.content)), "end of input handler");
}
